...
function Post({ post }: Props) {
  ...
  return (
    <main>
          ...
          <PortableText
            ...
            serializers={{
              ...
              link: ({ href, children }: any) => (
                <a
                  href={href}
                  className=" text-gray-500 underline hover:text-green-600 hover:no-underline"
                >
                  {children}
                </a>
              ),
      ...
      {submitted ? (
        <div className=" my-10 mx-auto flex max-w-2xl flex-col items-center justify-center bg-green-500 py-10 text-white">
        ...
        >
          ...
          <label className="mb-5 block">
            ...
            <textarea
              ...
              className=" form-textarea mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-green-600 focus:ring"
